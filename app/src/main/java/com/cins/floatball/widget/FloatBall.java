package com.cins.floatball.widget;
 ...
 */
public class FloatBall extends FrameLayout implements View.OnTouchListener {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == HANDLER_TYPE_HIDE_LOGO) {
                if (mCanHide) {
                    ...
                    mWindowManager.updateViewLayout(FloatBall.this, mWmParams);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                mIvFloatLogo.setImageResource(ResourceUtils.getDrawableId(mContext,"image_float_logo"));
                mWmParams.alpha = 1f;
                mWindowManager.updateViewLayout(this, mWmParams);
                mDraging = false;
                break;
